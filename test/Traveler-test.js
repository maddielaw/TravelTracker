...
describe('Traveler', () => {
  ...
  it('should be able to find a traveler\'s destinations', function () {
    expect(traveler.findTravelerDestinations()).to.eql([
      {
        id: 89,
        userID: 2,
        destinationID: {
  ...
  it('should be able to calculate how many days a traveler has traveled for current year', function () {
    expect(traveler.findNumDaysTraveledThisYear()).to.eql(26)
  });
